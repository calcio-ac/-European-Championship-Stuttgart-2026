...
drop function if exists admin_upsert_team(uuid, text, text, text, int, text, text, text);
...
-- Coordinators: limited accounts that can only edit team squads.
...
-- Admins and coordinators can save any team's squad.
...
insert into matches (id, phase, round, group_code, ground, kickoff, end_time, home_slot, away_slot, sort_order) values
  ...
  ('M03','group',null,'D',1,'09:00','09:30','D4','D2',3),
  ('M04','group',null,'D',2,'09:00','09:30','D3','D1',4),
  ('M05','group',null,'C',1,'09:30','10:00','C1','C3',5),
  ('M06','group',null,'C',2,'09:30','10:00','C2','C4',6),
  ('M07','group',null,'D',1,'10:00','10:30','D1','D4',7),
  ('M08','group',null,'D',2,'10:00','10:30','D2','D3',8),
  ...
  ('M17','group',null,'D',1,'12:30','13:00','D1','D2',17),
  ('M18','group',null,'D',2,'12:30','13:00','D4','D3',18),
